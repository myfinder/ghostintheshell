package ghostintheshell::Web::View;
use strict;
use warnings;
use utf8;
use Carp ();
...
use ghostintheshell::Web::ViewFunctions;

# setup view class
sub make_instance {
    my ($class, $context) = @_;
    Carp::croak("Usage: ghostintheshell::View->make_instance(\$context_class)") if @_!=2;
    ...
    my $view = Text::Xslate->new(+{
        ...
        'module'   => [
            ...
            'ghostintheshell::Web::ViewFunctions',
        ],
        'function' => {
        },
